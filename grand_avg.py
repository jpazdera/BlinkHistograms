...
try:
    with open('/Users/jessepazdera/Desktop/low_blinks_0.5.json') as f:
        low = json.load(f)['low']
except:
    traceback.print_exc()
...
pdf = matplotlib.backends.backend_pdf.PdfPages('/Users/jessepazdera/Desktop/Average Blink Stats (>50%).pdf')
